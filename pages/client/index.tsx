...
const scrollable = { onTouchMove: function(e: any) { e.stopPropagation(); e.stopImmediatePropagation(); } }
...
function Layout ({ children, basic }: { basic?: boolean, children: any }) {
    ...
    return (
        <>
            ...
            `}
            <div className="base-element" style={{
                width: "100vw",
                height: "100svh",
                background: 'white',
                margin: '0px',
                ...
                {!basic && <div style={{
                    ...
                    <div style={{
                        ...
                        <Text h5 my={0}>Device ID</Text>
                        <Text style={{
                            fontSize: '12px'
                        }} mb={0} mt="-2px">{deviceId}</Text>
                    </div>
                    <GeistButton onClick={() => location.reload()} icon={<Settings />} auto>Settings</GeistButton>
                </div>}
            </div>
        </>
    )
...
function Button ({ children, onClick }: { children?: any, onClick?: (e: MouseEvent<HTMLButtonElement>) => any }) {
...
function LinkCode () {
    return (
        <>
            <Text h1 font="sofiapro" style={{
                fontSize: '140px',
                color: "#1f2d3d",
                fontWeight: '600'
            }} my={0}>ABC DEF</Text>

            <Text h3 font="sofiapro" mt={-1} style={{
                color: '#8492a6',
                fontWeight: 400,
                maxWidth: '42vw',
                textAlign: 'center',
                ...
                Go to hackathon.zip/link on your computer to connect this iPad to your event.
            </Text>
        </>
    )
}
...
function Home () {
    ...
    return (
        <>
            ...
            />
            <Text h2 font="sofiapro" mt={3} mb={0} style={{
                color: "#1f2d3d",
                fontSize: '36px'
            }}>Welcome to Hackathon.zip Check In!</Text>

            <Text h3 font="sofiapro" mt={0} mb={2} style={{
                color: '#8492a6',
                fontWeight: 400,
                maxWidth: '45vw',
                textAlign: 'center',
                fontSize: '22px'
            }}>If you're ready for a secure and seamless attendee check-in experience, then let's get started!</Text>

            <Button onClick={(e: any) => push(<LinkCode />)}>I have a Hackathon.zip account</Button>
            <Text h4 font="sofiapro" my={1} style={{
                color: '#8492a6',
                fontWeight: 400,
                fontSize: '18px'
            }}>To proceed you will need a Hackathon.zip account</Text>
        </>
    )
}
...
export default function Index () {
    return (
        <NavigationProvider defaultView={<Home />} layout={Layout} />
    )
}
